...
exports.discordContentSecurityPolicy = void 0;
const config_1 = require("./config");
const t = (new config_1.AppConfig()).get().csp.thirdparty;
...
if (t.paypal)
    csp += "; child-src 'self' https://checkout.paypal.com";
exports.discordContentSecurityPolicy = csp;
